...
export function generateNameFromTemplate(item, template, options = {}) {
...
export function extractRegionFromName(name) {
...
export function extractStainFromName(name) {
...
export function getTemplatePreview(template, sampleItem, options = {}) {
    try {
...
export function createCustomTemplate(name, description, template) {
